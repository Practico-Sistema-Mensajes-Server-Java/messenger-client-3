...
COPY --from=build /app/target/messenger-client-3-0.0.1-SNAPSHOT.jar /app/messenger-client-3.jar
...
ENTRYPOINT ["./wait-for-it.sh", "mysql-messenger-client-3:3306", "--", "java", "-jar", "/app/messenger-client-3.jar"]
